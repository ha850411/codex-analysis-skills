...
- 未來能力先驗：FanGraphs Depth Charts 的 rest-of-season Steamer／ZiPS，或來源與版本可追溯的其他 projection
- 投手與打者 Statcast、bat tracking、Fielding／Baserunning Run Value：Baseball Savant
- Stuff+、Location+、Pitching+、wRC+、K-BB%、Depth Charts：FanGraphs
- Game logs、歷史紀錄：Baseball-Reference
- 球隊近期 box score：MLB.com / ESPN

投影版本與資料擷取時間都要保存。ERA、打擊率、近期勝敗與原始 batter-vs-pitcher 紀錄只能作背景，不能作為核心依據。
...
最近 3 天每位投手的球數、連投、角色與手別接手路徑，比整體牛棚 ERA 更重要，尤其對全場盤與大小分。

## 天氣與球場

1. Weather.gov 或可靠天氣來源
2. 球場屋頂官方狀態
3. Baseball Savant 多年滾動且分左右打的 Statcast Park Factors
4. 其他 park factor 只能交叉確認；單季小樣本需收縮

風向要說明是往外野、往內野、左外野或右外野，不要只寫有風。

## 規則與制度環境

1. MLB 官方規則、press release 與 Baseball Savant 制度頁
2. 球隊官方／MLB Gameday 的當場適用狀態
3. 其他媒體只作說明與交叉確認

2026 起優先查核 ABS Challenge System 是否適用於該場與場地，並使用同制度樣本評估主審、捕手 framing 與挑戰能力；不得把 2025 前係數原封不動套用。
