...
- 同隊伍下一場勝率信心上限先下修 8–12 個百分點，直到用同 Patch 新 VOD 或官方數據解除。
...
- 若原模型把落敗方至少一圖給到 75% 以上但實際被橫掃，下一次同類 BO5 的落敗方至少一圖預設上限降到 65–70%，直到能找到兩條獨立取圖路徑。
- 若原模型給熱門方 63% 以上但實際輸掉，下一次同隊伍或同賽事對戰的熱門方獨贏上限先設 58–60%，除非逐圖與 VOD 都支持恢復。
