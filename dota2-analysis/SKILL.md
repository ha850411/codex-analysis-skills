...
預設繁體中文、台灣時間（Asia/Taipei）。BO2 必須包含 2-0／1-1／0-2；不可硬轉二路獨贏。

## 執行契約

先讀 `../shared/analysis-core.md`；產生新機率再讀 `../shared/forecast/contract.md`。共用層負責時間、快照、機率、評估與輸出；本技能負責 版本、實際五人與角色、英雄池、draft、分路及 Radiant／Dire。
