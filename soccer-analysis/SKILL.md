...
預設繁體中文、台灣時間（Asia/Taipei）。只分析世界盃決賽圈及使用者明確指定的資格賽、附加賽、抽籤、出線；90 分鐘與晉級分開。

## 執行契約

先讀 `../shared/analysis-core.md`；產生新機率再讀 `../shared/forecast/contract.md`。共用層負責時間、快照、機率、評估與輸出；本技能負責 國家隊名單、傷停、攻防與進球環境、場地、賽程及淘汰賽規則。
