...
1. 主辦方官方賽程、rulebook 或公告
2. HLTV.org match page
3. Liquipedia Counter-Strike tournament page
4. 其他比分網站

官方來源優先處理改期、特殊賽制與 veto 規則；HLTV 優先用於 match page、隊伍近期戰績與地圖紀錄。Liquipedia 用於賽事階段與分組補充。

## 陣容與 stand-in

1. Team official announcement 或主辦方當場 roster
2. HLTV match page 或 team page
...
- HLTV player stats：使用頁面當下的主要 Rating 版本（目前為 Rating 3.0）、ADR、KAST、K-D diff、opening duels；不可把不同 Rating 世代當成同尺度直接比較。
